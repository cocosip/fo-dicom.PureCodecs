...
- The scan codec implements regular mode, run mode, Golomb coding, context modeling, default or LSE-provided JPEG-LS thresholds and reset values, and near-lossless sample reconstruction.
